...
SRC32FLAT=$(SRCBOTH) post.c e820map.c malloc.c romfile.c x86.c optionroms.c \
    ...
    fw/kvm.c fw/acpi.c fw/mptable.c fw/pirtable.c fw/smbios.c \
    fw/romfile_loader.c hw/virtio-ring.c hw/virtio-pci.c hw/virtio-blk.c \
    hw/virtio-scsi.c hw/tpm_drivers.c hw/nvme.c
